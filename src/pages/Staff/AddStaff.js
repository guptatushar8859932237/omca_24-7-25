                  ...
                  {({ isSubmitting, setFieldValue, values }) => (
                    <Form>
                      <div className="row gx-3 gy-3">
                        ...
                        <div className="col-md-4">
                          <div className="set-field">
                            ...
                            <div className="country-code">
                              <input
                                type="text"
                                className="code-dial form-control"
                                value={values.dial_code}
                                disabled
                              />
                              <input
                                type="text"
                                className="code-in form-control"
                        ...
                        <div className="col-md-4 dropdownCustom">
                          <div className="set-field">
                            <label>Data Access Country<span className="text-danger">*</span></label>
                            <FormControl fullWidth size="small">
                              <Select
                                multiple
                              ...
                              >
                                {/* Select All */}
                                <MenuItem value="All" className="custmselect staffpermiss">
                                  <Checkbox
                                    checked={
                                      values.accessCountries.length ===
                                      Countries.length
                                ...
                                {Countries?.map((country) => (
                                  ...
                                  >
                                    <Checkbox
                                      checked={
                                        values.accessCountries.indexOf(
                                          country.name,
                                        ) > -1
                                      }
                                    />
                            ...
                            <div className="profile-upload">
                              <div className="upload-img">
                                {selectedImage ? (
                                  ...
                                  <img alt="default avatar" src="https://www.shutterstock.com/image-vector/profile-default-avatar-icon-user-600nw-2463844171.jpg" />
                                )}
                              </div>
                        ...
                        <div className="col-md-4 dropdownCustom">
                          <div className="set-field">
                            <label>Give Permission<span className="text-danger">*</span></label>
